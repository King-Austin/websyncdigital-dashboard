        ...
        <div style={{ maxWidth:480, margin:'0 auto', animation:'fadeInUp 0.4s ease both' }}>
          ...
          {step === 0 && (
            <div>
              ...
              <button type="button" onClick={handleGoogle} disabled={loading} style={{ width:'100%', padding:12, background:'#fff', color:'#141310', border:'1.5px solid rgba(0,0,0,0.16)', borderRadius:10, fontSize:14, fontWeight:600, fontFamily:'var(--font-app)', cursor:loading?'not-allowed':'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:10, opacity:loading?0.6:1 }}>
